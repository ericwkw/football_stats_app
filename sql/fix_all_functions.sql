-- Comprehensive fix for player impact analysis functions

-- Fix for the team performance function to correctly identify matches where the player played
...
-- Fix for the player multi-team impact function
DROP FUNCTION IF EXISTS public.get_player_all_teams_impact(text);

-- Recreate the team performance function with the correct implementation
...
-- Recreate the multi-team impact function with the correct implementation
