-- Setup script for player team analysis functions
-- This script creates all the necessary database functions for analyzing player impact across teams

-- ===============================================
-- FUNCTION 1: Player Impact Across Multiple Teams
-- ===============================================
...
BEGIN
  ...
  player_stats AS (
    ...
    FROM
      public.player_match_assignments pma
    JOIN
      public.player_stats ps ON ps.match_id = pma.match_id AND ps.player_id = pma.player_id
    WHERE
      pma.player_id = player_id_uuid
      AND pma.team_id IS NOT NULL
    GROUP BY
...
-- ========================================================
-- FUNCTION 2: Player Combinations Analysis Within a Team
-- ========================================================
...
-- Grant permissions for function 1
...
-- Grant permissions for function 2
